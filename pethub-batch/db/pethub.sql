...
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (8,6,'dog','강이지 분양','http://www.dogfarm.co.kr/gnu/index.php','kr.pethub.site.DogfarmCoKr','getDogList','getDogContent',95,'8','Y','2019-07-11 00:00:00','2019-07-11 00:00:00','2019-07-17 23:11:40');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (9,7,'dog','강이지 분양','http://www.animal.or.kr/bbs/board.php?bo_table=commu_08','kr.pethub.site.AnimalOrKr','getDogList','getDogContent',25,'8','Y','2019-07-11 00:00:00','2019-07-11 00:00:00','2019-07-16 20:28:29');
