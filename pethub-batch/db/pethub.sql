...
insert into `site_info`(`site_srl`,`site_nm`,`site_url`,`site_etc`,`reg_dt`,`upt_dt`) values (5,'우리펫','http://www.우리펫.com','강아지, 고양이 분양','2019-07-10 00:00:00','2019-07-10 00:00:00');



insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (1,1,'dog','강아지 분양','https://dogmaru.co.kr/sdog','kr.pethub.site.DogmaruCoKr','getDogList','getDogContent',20,'6','Y','2019-07-05 00:00:00','2019-07-06 13:20:07','2019-07-09 15:04:40');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (2,1,'cat','고양이 분양','https://dogmaru.co.kr/cat','kr.pethub.site.DogmaruCoKr','getCatList','getCatContent',20,'6','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-09 15:05:01');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (3,2,'dog','강아지 분양','http://www.theilovedog.com/dog/list.php?category=1','kr.pethub.site.TheilovedogCom','getDogList','getDogContent',18,'6','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-09 15:05:04');
