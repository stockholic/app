...
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (1,1,'dog','강아지 분양','https://dogmaru.co.kr/sdog','kr.pethub.site.DogmaruCoKr','getDogList','getDogContent',20,'8','Y','2019-07-05 00:00:00','2019-07-06 13:20:07','2019-07-12 20:41:56');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (2,1,'cat','고양이 분양','https://dogmaru.co.kr/cat','kr.pethub.site.DogmaruCoKr','getCatList','getCatContent',20,'8','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-12 20:41:43');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (3,2,'dog','강아지 분양','http://www.theilovedog.com/dog/list.php?category=1','kr.pethub.site.TheilovedogCom','getDogList','getDogContent',18,'8','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-12 20:44:47');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (4,3,'dog','강아지 분양','http://www.zooseyo.com/sale/sale_list.php?animal=dog','kr.pethub.site.ZooseyoCom','getDogList','getDogContent',25,'1','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-12 20:46:39');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (5,3,'cat','고양이 분양','http://www.zooseyo.com/sale/sale_list.php?animal=cat','kr.pethub.site.ZooseyoCom','getCatList','getCatContent',27,'1','Y','2019-07-06 00:00:00','2019-07-06 00:00:00','2019-07-12 20:46:33');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (6,4,'dog','강이지 분양','http://www.dog-zzang.co.kr/dog_sale/safe_list.php','kr.pethub.site.DogZzangCoKr','getDogList','getDogContent',50,'1','Y','2019-07-09 13:43:36','2019-07-09 13:43:36','2019-07-12 21:08:09');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (7,5,'dog','강이지 분양','http://www.xn--oy2b11v46j.com/shop/shop/listtype.php?type=4','kr.pethub.site.WooripetCom','getDogList','getDogContent',15,'6','Y','2019-07-10 00:00:00','2019-07-10 00:00:00','2019-07-12 20:45:34');
...
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (9,7,'dog','강이지 분양','http://www.animal.or.kr/bbs/board.php?bo_table=commu_08','kr.pethub.site.AnimalOrKr','getDogList','getDogContent',25,'8','Y','2019-07-11 00:00:00','2019-07-11 00:00:00','2019-07-12 20:38:35');
insert into `site_link`(`link_srl`,`site_srl`,`link_cd`,`link_nm`,`link_url`,`link_cls`,`link_mtd_lst`,`link_mtd_cts`,`link_cnt`,`batch_itv`,`use_yn`,`reg_dt`,`upt_dt`,`exc_dt`) values (10,8,'dog','강아지 분양','http://www.dogsijang.co.kr/board_dog/list.php?tb=board_sale','kr.pethub.site.DogsijangCoKr','getDogList','getDogContent',121,'1','Y','2019-07-12 00:00:00','2019-07-12 00:00:00','2019-07-12 20:32:59');
